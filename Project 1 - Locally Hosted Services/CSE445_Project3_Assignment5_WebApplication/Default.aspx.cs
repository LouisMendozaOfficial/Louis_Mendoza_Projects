...
namespace CSE445_Project3_Assignment5_WebApplication
{
    public partial class _Default : Page
    {
        ...
        {
            RequiredWordServices.Service1Client WordFilterService = new RequiredWordServices.Service1Client();
        ...
        {
            RequiredWordServices.Service1Client TopTenWordsFilter = new RequiredWordServices.Service1Client();
